    ...
    blog.main = {
        ...
        initLegacyChar() {
            jQuery(document).ready($ => {
                ...
                const newCust = [[0, 3], [1, 5], [2, 4], [3, 7], [4, 9], [5, 3], [6, 6], [7, 4], [8, 10]];

                const plot = $.plot($('#flotLine5'), [{
                    data: newCust,
                    label: 'New Data Flow',
                    color: '#fff'
                }],
                ...
                if ($('#traffic-chart').length) {
                    const chart = new Chartist.Line('#traffic-chart', {
                ...
                $.plot('#flotBarChart', [{
                    data: [[0, 18], [2, 8], [4, 5], [6, 13], [8, 5], [10, 7], [12, 4], [14, 6], [16, 15], [18, 9],
                        [20, 17], [22, 7], [24, 4], [26, 9], [28, 11]],
                    bars: {
                        show: true,
                        lineWidth: 0,
                        fillColor: '#ffffff8a'
